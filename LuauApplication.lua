...
-- Submitted/Scripted by @ftwcash (discord)
-- Local Script:
--==================================================
...
local function slideIn()
	...
	frame.Position = UDim2.new(originalPos.X.Scale, originalPos.X.Offset,
	                           originalPos.Y.Scale, originalPos.Y.Offset + offset)
	frame.Visible = true
...
Players.PlayerAdded:Connect(function(player)
	player.CharacterAdded:Connect(function(character)
		...
		-- Track touches for safe teleport
...
-- Handle purchase and teleport player safely
